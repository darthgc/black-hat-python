...
class AslrCheck(interfaces.plugins.PluginInterface):
    ...
    def get_requirements(cls):
        return [
            ...
            requirements.SymbolTalbeRequirement(
                name="nt_symbols",
        ...
        for proc in procs:
            ...
            try:
                dos_header = self.context.object(
                    ...
                    loayer_name=proc_layer_name,
                    offsec=peb.ImageBaseAddress
                )
            ...
            yield (0, proc_id, procname, format_hints.Hex(pe.OPTIONALE_HEADER.ImageBase, aslr,))
